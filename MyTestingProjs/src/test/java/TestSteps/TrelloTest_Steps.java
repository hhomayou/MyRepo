...
public class TrelloTest_Steps extends Setup {
    ...
    public void afterEachScenrio() {
    	if(trelloElements.cardIsActvie()) trelloElements.closeCard();
    }
    ...
    public void member_is_added_from_the_card() throws Throwable {
     	if(!trelloElements.getMemberStatus(member)) throw new PendingException("Member [HH] not added to card [MyCard1] !");
    ...
    public void comment_is_added() throws Throwable {
    	if(!trelloElements.commentExists("Comment1")) throw new PendingException("Comment [Comment1] not added !");			
    ...
    public void comment_is_updated() throws Throwable {
    	if(!trelloElements.commentExists("Comment2")) throw new PendingException("Comment [Comment1] not updated to [Comment2] !");			   	
    ...
    public void revers_the_update() throws Throwable {
    	...
    	if(!trelloElements.commentExists("Comment1")) throw new PendingException("Comment [Comment2] not reveresed to [Comment1] !");			   	
    ...
    public void comment_is_removed() throws Throwable {
		if(trelloElements.commentExists("Comment1")) throw new PendingException("Comment [Comment1] not removed !");			
    ...
    public void duedate_is_removed() throws Throwable {
    	if(trelloElements.dueDateValue() != null) throw new PendingException("Due date not removed from [MyCard1]");
